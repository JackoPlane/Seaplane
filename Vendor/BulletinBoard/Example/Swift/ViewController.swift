...
class ViewController: UIViewController {
    @IBOutlet var styleButtonItem: UIBarButtonItem!
    @IBOutlet var segmentedControl: UISegmentedControl!
    @IBOutlet var showIntoButtonItem: UIBarButtonItem!
...
//        bulletinManager.backgroundColor = .blue
    ...
    @IBAction func styleButtonTapped(_: Any) {
    ...
    @IBAction func showIntroButtonTapped(_: UIBarButtonItem) {
        showBulletin()
    }
