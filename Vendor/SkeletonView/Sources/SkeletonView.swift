...
extension UIView {
    func addSkeletonLayer(withType type: SkeletonType, usingColors colors: [UIColor], gradientDirection _: GradientDirection? = nil, animated: Bool, animation: SkeletonLayerAnimation? = nil) {
        skeletonLayer = SkeletonLayerFactory().makeSkeletonLayer(withType: type, usingColors: colors, andHolder: self)
