...
public final class SinglePromptSecureEnclaveValet: NSObject {
    ...
    public func set(object: Data, forKey key: String) -> Bool {
        return execute(in: lock) {
            SecureEnclave.set(object: object, forKey: key, options: baseKeychainQuery)
        }
    }
    ...
    public func object(forKey key: String, withPrompt userPrompt: String) -> SecureEnclave.Result<Data> {
        return execute(in: lock) {
            SecureEnclave.object(forKey: key, withPrompt: userPrompt, options: continuedAuthenticationKeychainQuery)
        }
    }
    ...
    public func containsObject(forKey key: String) -> Bool {
        return execute(in: lock) {
            SecureEnclave.containsObject(forKey: key, options: baseKeychainQuery)
        }
    }
    ...
    public func set(string: String, forKey key: String) -> Bool {
        return execute(in: lock) {
            SecureEnclave.set(string: string, forKey: key, options: baseKeychainQuery)
        }
    }
    ...
    public func string(forKey key: String, withPrompt userPrompt: String) -> SecureEnclave.Result<String> {
        return execute(in: lock) {
            SecureEnclave.string(forKey: key, withPrompt: userPrompt, options: continuedAuthenticationKeychainQuery)
        }
    }
    ...
    public func removeObject(forKey key: String) -> Bool {
        return execute(in: lock) {
            Keychain.removeObject(forKey: key, options: baseKeychainQuery).didSucceed
        }
    }
    ...
    public func removeAllObjects() -> Bool {
        return execute(in: lock) {
            Keychain.removeAllObjects(matching: baseKeychainQuery).didSucceed
        }
    }
    ...
    public func migrateObjects(matching query: [String: AnyHashable], removeOnCompletion: Bool) -> MigrationResult {
        return execute(in: lock) {
            Keychain.migrateObjects(matching: query, into: baseKeychainQuery, removeOnCompletion: removeOnCompletion)
        }
    }
