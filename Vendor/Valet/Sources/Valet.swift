...
public final class Valet: NSObject, KeychainQueryConvertible {
    ...
    public func canAccessKeychain() -> Bool {
        return execute(in: lock) {
            Keychain.canAccess(attributes: keychainQuery)
        }
    }
    ...
    public func set(object: Data, forKey key: String) -> Bool {
        return execute(in: lock) {
            Keychain.set(object: object, forKey: key, options: keychainQuery).didSucceed
        }
    }
    ...
    public func object(forKey key: String) -> Data? {
        return execute(in: lock) {
            Keychain.object(forKey: key, options: keychainQuery).value
        }
    }
    ...
    public func containsObject(forKey key: String) -> Bool {
        return execute(in: lock) {
            Keychain.containsObject(forKey: key, options: keychainQuery).didSucceed
        }
    }
    ...
    public func set(string: String, forKey key: String) -> Bool {
        return execute(in: lock) {
            Keychain.set(string: string, forKey: key, options: keychainQuery).didSucceed
        }
    }
    ...
    public func string(forKey key: String) -> String? {
        return execute(in: lock) {
            Keychain.string(forKey: key, options: keychainQuery).value
        }
    }
    ...
    public func allKeys() -> Set<String> {
        return execute(in: lock) {
            Keychain.allKeys(options: keychainQuery).value ?? Set()
        }
    }
    ...
    public func removeObject(forKey key: String) -> Bool {
        return execute(in: lock) {
            Keychain.removeObject(forKey: key, options: keychainQuery).didSucceed
        }
    }
    ...
    public func removeAllObjects() -> Bool {
        return execute(in: lock) {
            Keychain.removeAllObjects(matching: keychainQuery).didSucceed
        }
    }
    ...
    public func migrateObjects(matching query: [String: AnyHashable], removeOnCompletion: Bool) -> MigrationResult {
        return execute(in: lock) {
            Keychain.migrateObjects(matching: query, into: keychainQuery, removeOnCompletion: removeOnCompletion)
        }
    }
